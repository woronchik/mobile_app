    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('model', 'Model'), ('photographer', 'Photographer'), ('user', 'User')], default='user', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_media', models.CharField(blank=True, max_length=150, null=True)),
                ('website', models.CharField(blank=True, max_length=150, null=True)),
                ('clothes_size', models.IntegerField(null=True)),
                ('shoes_size', models.IntegerField(null=True)),
                ('height', models.IntegerField(null=True)),
                ('bust', models.IntegerField(null=True)),
                ('waist', models.IntegerField(null=True)),
                ('hips', models.IntegerField(null=True)),
                ('look_type', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('hair_length', models.IntegerField(null=True)),
                ('known_languages', models.CharField(blank=True, max_length=150, null=True)),
